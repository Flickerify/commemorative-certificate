 ...
 * See: https://workos.com/docs/authkit/actions/build-the-endpoint-response/b-respond-manually
 */
...
export async function handleRegistrationActions(ctx: Context<WorkosHonoEnv>) {
